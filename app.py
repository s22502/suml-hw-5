...
def main():
    ...
    with right:
        ...
        sibsp_slider = st.slider("# Liczba rodzeństwa i/lub partnera", value=0, min_value=0, max_value=8)
        parch_slider = st.slider("Liczba rodziców i/lub dzieci", value=0, min_value=0, max_value=6)
    ...
    st.subheader("Aplikacja wykonana przez Barnaba Gańko - s22502")
